...
public class MensAccessoriesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Query query = db.collection("products").document("MenAccessories").collection("Items");
    ...
    private class ProductHolder extends RecyclerView.ViewHolder {
        ...
        public ProductHolder(@NonNull View itemView) {
            ...
            itemView.setOnClickListener(v -> {
                Intent intent = new Intent(MensAccessoriesActivity.this, ProductDetailActivity.class);
